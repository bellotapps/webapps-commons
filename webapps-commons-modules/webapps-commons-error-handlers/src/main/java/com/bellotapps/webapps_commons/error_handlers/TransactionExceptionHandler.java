...
public class TransactionExceptionHandler implements ExceptionHandler<TransactionException, ServerErrorDto> {
    ...
    @Override
    public HandlingResult<ServerErrorDto> handle(TransactionException exception) {
