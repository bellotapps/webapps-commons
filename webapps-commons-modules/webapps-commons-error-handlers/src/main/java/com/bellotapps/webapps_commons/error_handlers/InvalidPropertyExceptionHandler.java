...
public class InvalidPropertyExceptionHandler
        implements ExceptionHandler<InvalidPropertiesException, IllegalParamValueErrorDto> {

    @Override
    public HandlingResult<IllegalParamValueErrorDto> handle(final InvalidPropertiesException exception) {
        return HandlingResults.illegalParams(exception.getInvalidProperties());
    }
}
