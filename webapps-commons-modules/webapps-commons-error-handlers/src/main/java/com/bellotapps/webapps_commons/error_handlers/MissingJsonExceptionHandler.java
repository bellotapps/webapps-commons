 ...
 * Will handle according to {@link HandlingResults#BAD_REPRESENTATION} result.
 */
@ExceptionHandlerObject
public class MissingJsonExceptionHandler implements ExceptionHandler<MissingJsonException, RepresentationErrorDto> {

    @Override
    public HandlingResult<RepresentationErrorDto> handle(final MissingJsonException exception) {
        return HandlingResults.BAD_REPRESENTATION;
    }
}
