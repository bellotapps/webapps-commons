...
public class JDBCExceptionHandler implements ExceptionHandler<JDBCException, ServerErrorDto> {
    ...
    @Override
    public HandlingResult<ServerErrorDto> handle(JDBCException exception) {
