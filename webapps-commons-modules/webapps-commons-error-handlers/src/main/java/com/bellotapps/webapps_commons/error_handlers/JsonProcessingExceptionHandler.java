...
public class JsonProcessingExceptionHandler
        implements ExceptionHandler<JsonProcessingException, RepresentationErrorDto> {

    @Override
    public HandlingResult<RepresentationErrorDto> handle(final JsonProcessingException exception) {
