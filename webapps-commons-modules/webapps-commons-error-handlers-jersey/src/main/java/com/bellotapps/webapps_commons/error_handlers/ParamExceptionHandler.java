...
import com.bellotapps.webapps_commons.web.dtos.api_errors.InvalidParamValueErrorDto;
...
public class ParamExceptionHandler implements ExceptionHandler<ParamException, InvalidParamValueErrorDto> {

    @Override
    public HandlingResult<InvalidParamValueErrorDto> handle(ParamException exception) {
        return HandlingResult.withPayload(HttpStatus.BAD_REQUEST.getCode(),
