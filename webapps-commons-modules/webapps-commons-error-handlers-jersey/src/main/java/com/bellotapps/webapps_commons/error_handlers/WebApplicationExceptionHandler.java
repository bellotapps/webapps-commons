...
public class WebApplicationExceptionHandler implements ExceptionHandler<WebApplicationException, Void> {

    @Override
    public HandlingResult<Void> handle(WebApplicationException exception) {
        return HandlingResult.justErrorCode(exception.getResponse().getStatus());
    }
}
